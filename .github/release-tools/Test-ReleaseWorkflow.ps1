...
Assert-WorkflowContains -Text $workflowText -Expected 'actions/setup-java@de7274f081f381c8f8158605e0321c36c376e2e6 # v6.0.1' -Description 'assembly SHA-pinned exact Java setup'
