...
public static partial class SDL
{
    public static partial class Props
    {
        ...
        public const string GPUDeviceCreateXRInstanceOutPointer = "SDL.gpu.device.create.xr.instance_out";
        public const string GPUDeviceCreateXRSystemIdOutPointer = "SDL.gpu.device.create.xr.system_id_out";
