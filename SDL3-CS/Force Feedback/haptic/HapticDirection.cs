...
public static partial class SDL
{
    ...
    /// <list type="bullet">
    /// <item><see cref="HapticPolar"/> : Specified by polar coordinates.</item>
    /// <item><see cref="HapticCartesian"/> : Specified by cartesian coordinates.</item>
    /// <item><see cref="HapticSpherical"/> : Specified by spherical coordinates.</item>
    /// </list>
    ...
    ///                 ---ooO-(_)-Ooo---
    /// </code>
    /// <para>If type is <see cref="HapticPolar"/>, direction is encoded by hundredths of a degree
    /// starting north and turning clockwise. <see cref="HapticPolar"/> only uses the first
    ...
    /// </list>
    /// <para>If type is <see cref="HapticCartesian"/>, direction is encoded by three positions (X
    /// axis, Y axis and Z axis (with 3 axes)). <see cref="HapticCartesian"/> uses the first
    ...
    /// <para>If type is <see cref="HapticSpherical"/>, direction is encoded by two rotations. The
