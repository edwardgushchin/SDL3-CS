...
internal static class Program
{
    ...
    private static void RenderFrame(RendererExampleContext context, double now)
    {
        ...
        SDL.SetTextureColorModFloat(texture.Handle, 0.0f, 0.0f, 1.0f);
        ...
        SDL.SetTextureColorModFloat(texture.Handle, red, green, blue);
        SDL.RenderTexture(context.Renderer, texture.Handle, IntPtr.Zero, in dstRect);

        dstRect.X = WindowWidth - texture.Width;
        dstRect.Y = WindowHeight - texture.Height;
        SDL.SetTextureColorModFloat(texture.Handle, 1.0f, 0.0f, 0.0f);
        SDL.RenderTexture(context.Renderer, texture.Handle, IntPtr.Zero, in dstRect);
