...
<p align="center">
  ...
  <img alt="SDL3 target 3.4.16" src="https://img.shields.io/badge/SDL3%20target-3.4.16-239120?style=flat-square">
...
|-----------|-----------------|---------------|--------------|
| SDL3 managed bindings | `SDL3-CS` | SDL `3.4.16` | `3.4.16.x` |
