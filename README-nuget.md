...
Current stable release: [`SDL3-CS 3.4.12.6`](https://github.com/edwardgushchin/SDL3-CS/releases/tag/v3.4.12.6).

| Package family | Version |
|----------------|---------|
| `SDL3-CS` | `3.4.12.6` |
| `SDL3-CS.<Platform>` | `3.4.12.6` |
| `SDL3-CS.<Platform>.Image` | `3.4.4.6` |
| `SDL3-CS.<Platform>.Mixer` | `3.2.4.6` |
| `SDL3-CS.<Platform>.TTF` | `3.2.2.6` |
| `SDL3-CS.<Platform>.Shadercross` | `3.0.0.6` |
