...
Current stable release: [`SDL3-CS 3.4.12`](https://www.nuget.org/packages/SDL3-CS/3.4.12).

| Package family | Version |
|----------------|---------|
| `SDL3-CS` | `3.4.12` |
| `SDL3-CS.<Platform>` | `3.4.12` |
| `SDL3-CS.<Platform>.Image` | `3.4.4` |
| `SDL3-CS.<Platform>.Mixer` | `3.2.4` |
| `SDL3-CS.<Platform>.TTF` | `3.2.2` |
| `SDL3-CS.<Platform>.Shadercross` | `3.0.0` |
