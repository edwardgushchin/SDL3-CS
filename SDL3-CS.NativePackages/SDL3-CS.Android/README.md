...
<p align="center">
  ...
  <img alt="SDL 3.4.14" src="https://img.shields.io/badge/native-SDL%203.4.14-004880?style=flat-square">
</p>
...
|---------|------------------------|--------------|
| `SDL3-CS.Android` | SDL 3.4.14 | `3.4.14.x` |
...
|---------|------------------|-------------------|
| `SDL3-CS.Android` | SDL 3.4.14 | Core SDL3 runtime assets. |
