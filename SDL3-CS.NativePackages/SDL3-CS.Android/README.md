...
<p align="center">
  ...
  <img alt="SDL 3.4.16" src="https://img.shields.io/badge/native-SDL%203.4.16-004880?style=flat-square">
</p>
...
|---------|------------------------|--------------|
| `SDL3-CS.Android` | SDL 3.4.16 | `3.4.16.x` |
...
|---------|------------------|-------------------|
| `SDL3-CS.Android` | SDL 3.4.16 | Core SDL3 runtime assets. |
| `SDL3-CS.Android.Image` | SDL_image 3.4.6 | Image loading and saving. |
